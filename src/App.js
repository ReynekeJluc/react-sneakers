				...
				<header>
					<a href="?" className="logo">
						<div className="logo__block">
							<img src="img/icons/logo.png" alt="logotype" width={40} height={40}/>
					...
					<div className="content">
						...
						<ul className="list__sneakers">
							<li className="sneakers">
								<a href="?">
									<img src="/img/icons/favor_def.svg" className="sneakers__favor" alt="favor_icon" />
								</a>
								<a href="?">
									<img src="/img/sneakers1.jpg" className="sneakers__image" alt="image sneakers" />
								</a>
								...
								<div className="block__info">
									...
									<a href="?">
										<img src="/img/icons/added_def.svg" className="sneakers__added" alt="add" />
									</a>
								</div>
							</li>
							<li className="sneakers">
